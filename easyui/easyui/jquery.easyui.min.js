...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"This field is required.",invalidMessage:null,tipPosition:"top",deltaX:0,novalidate:false,events:{focus:_422,blur:_426,mouseenter:_42a,mouseleave:_42d,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
}},tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
$(this).tooltip("tip").css({color:"#333",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},
//改变提示框位置
onPosition: function(){
...
//datebox单击文本框出现日期选择 cz2015/12/10 
if ($(_45e).hasClass("datebox-f")) {
	_462.click(function() {
		$(_45e).datebox('showPanel');
		});
}
